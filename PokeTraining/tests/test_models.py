...
class PokemonTestCase(TestCase):
    ...
    def test_pokemon(self):
        ...
        self.assertEqual(charizard.pkmn_type1, 'FIRE', "Charizard's first type should be 'Fire'")
        self.assertEqual(charizard.pkmn_type2, 'FLYING', "Charizard's second type should be 'Flying'")
        self.assertEqual(charizard.pkmn_gender, 'F', "Charizard should be a female")
        self.assertEqual(charizard.pkmn_language, 'ENGLISH', "Charizard should have originated from an English game")
        self.assertEqual(charizard.ball_captured, 'BEAST', "Charizard should have been caught in a Beast Ball")
        self.assertEqual(charizard.original_generation, '1', "Charizard should originally be from generation 1")
        self.assertEqual(charizard.ability, 'BLAZE', "Charizard's ability should be 'Blaze' as its first ability")
